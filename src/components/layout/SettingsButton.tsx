...
import { Settings, X, Shield, Check, Trash2, Key } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-8">
          ...
          {/* Section 2: Parental Control PIN */}
          <div className="flex flex-col gap-4">
              ...
              {pin ? (
                ...
                <form onSubmit={handleSetPinSubmit} className="flex flex-col gap-3 pt-2 border-t border-gray-200/50">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-gray-600">新しい4桁のPINを入力</label>
                    <input
                      type="password"
                      maxLength={4}
                      value={inputPin}
